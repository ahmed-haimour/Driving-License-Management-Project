...
namespace DVLD_License_Management.Applications.Rlease_Detained_License
{
    public partial class frmListDetainedLicenses : Form
    {
        ...
        frmDetainLicenseHome DetainLicenseHome;
        public frmListDetainedLicenses(frmDetainLicenseHome DetainLicenseHome)
        {
            InitializeComponent();
            this.DetainLicenseHome = DetainLicenseHome;
        }
        ...
        private void btnUnReleased_Click(object sender, EventArgs e)
        {
        ...
        {
            this.Close();
            Panel panel = DetainLicenseHome.GetPanel();
            panel.Hide();
        }
    }
}
