...
namespace DVLD_Buisness
{
    public class clsUser
    {
        ...
        public static byte CountUser()
        {
            return clsUserData.GetUserCount();
        }
        ...
        public bool SaveChangePsasword(string Password)
        {
            switch(Mode)
            {
                case enMode.AddNew:
                ...
                case enMode.Update:
                    return ChangePassword(this.UserID, Password);
        ...
        public static DataTable GetAllUsersByActive(bool isActive)
        {
            return clsUserData.GetAllUsersByActive(isActive);
        }
